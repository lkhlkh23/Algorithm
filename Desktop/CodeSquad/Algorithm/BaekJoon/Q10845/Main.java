...
public class Main {
	...
	public static void selectCommand(String cmd, List<Integer> queue, StringBuilder sb) {
	...
	public static void push(int num, List<Integer> list) {
		list.add(num);
	}
